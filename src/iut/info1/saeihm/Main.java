...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            AnchorPane vueAccueil = 
            FXMLLoader.load(getClass().getResource("VueAccueil.fxml"));
            sceneAccueil = new Scene(vueAccueil, 818, 456);

            AnchorPane vueSelection = 
            FXMLLoader.load(getClass().getResource("VueSelectionJoueur.fxml"));
            sceneSelection = new Scene(vueSelection, 818, 456);

            AnchorPane vueJeu = 
            FXMLLoader.load(getClass().getResource("VueJeu.fxml"));
            sceneJeu = new Scene(vueJeu, 818, 456);
            
            AnchorPane vueParametres = 
            FXMLLoader.load(getClass().getResource("VueParametres.fxml"));
            sceneJeu = new Scene(vueJeu, 818, 456);
