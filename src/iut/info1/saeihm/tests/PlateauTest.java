...
class PlateauTest {
    ...
    void testGetCase() {
        assertEquals(0, plateau.getCase(0, 0), 
        		     "La case (0,0) doit être initialisée à 0.");
        assertEquals(0, plateau.getCase(9, 9), 
        		     "La case (9,9) doit être initialisée à 0.");
    }
    ...
    void testSequenceInterrompue() {
        ...
        plateau.setCase(0, 4, 1);
        assertFalse(plateau.rechercheSequences(0, 0, 1)
        		    , "Une séquence interrompue ne "
                    +"doit pas être détectée comme valide.");
    }
